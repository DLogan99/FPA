...
## Features
- Purchases/Items: add, edit, view, delete, import from CSV, and score via configurable weights.
- Money: track income/expense entries and link them to purchases by ID.
